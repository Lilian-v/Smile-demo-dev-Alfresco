...
if (typeof Smile.dashlet == "undefined" || !Smile.dashlet) {
	Smile.dashlet = {};
}
...
(function() {
	 ...
	 * @constructor
	 */
	Smile.dashlet.HelloWorld = function HelloWorld_constructor(htmlId) {
		return Smile.dashlet.HelloWorld.superclass.constructor.call(this, "Smile.dashlet.HelloWorld", htmlId);
	};

	/**
	 * Extend from Alfresco.component.Base and add class implementation
	 */
	YAHOO.extend(Smile.dashlet.HelloWorld, Alfresco.component.Base, {
		/**
